<%@ Page Title="Stock Out Operation" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StockOut.aspx.cs" Inherits="InventorySystem.StockOut" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container-fluid mt-4 px-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 pb-2 border-bottom">
            <div>
                <h4 class="fw-normal mb-1 text-dark">Stock Out Dispatch</h4>
                <div class="text-muted small">Inventory / Remove Stock</div>
            </div>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-5">
                <div class="card border border-light shadow-sm p-4 rounded-3 bg-white">
                    <h6 class="fw-bold text-dark mb-3"><i class="bi bi-qr-code-scan me-2 text-primary"></i> Scan & Dispatch</h6>
                    <hr class="mt-0 mb-4 border-light" />

                    <%-- FIXED: Added the explicit Label inside the Panel to resolve the Text error --%>
                    ...
                    <div class="mb-3">
                        <label class="form-label small fw-bold text-muted text-uppercase mb-1">Quantity to Remove <span class="text-danger">*</span></label>
                        <asp:TextBox ID="txtQty" runat="server" CssClass="form-control" TextMode="Number" min="1" placeholder="Enter quantity"></asp:TextBox>
                    </div>

                    <div class="mb-3">
                        <label class="form-label small fw-bold text-muted text-uppercase mb-1">Dispatch Reason <span class="text-danger">*</span></label>
                        <asp:DropDownList ID="ddlReason" runat="server" CssClass="form-select">
                            <asp:ListItem Text="Customer Sale (Revenue)" Value="Customer Sale" />
                            <asp:ListItem Text="Damaged / Scrap (Inventory Loss)" Value="Damaged / Scrap" />
                            <asp:ListItem Text="Internal Use / Hardware Store Supply" Value="Internal Use" />
                            <asp:ListItem Text="Missing / Stolen (Audit Discrepancy)" Value="Missing / Stolen" />
                        </asp:DropDownList>
                    </div>

                    <div class="mb-4">
                        <label class="form-label small fw-bold text-muted text-uppercase mb-1">Reference No / Invoice No <span class="text-danger">*</span></label>
                        <asp:TextBox ID="txtReference" runat="server" CssClass="form-control" placeholder="e.g. INV-2026-0001"></asp:TextBox>
                    </div>

                    <asp:LinkButton ID="btnConfirm" runat="server" CssClass="btn btn-danger w-100 fw-bold py-2 rounded-2 d-flex align-items-center justify-content-center gap-2" OnClick="btnConfirm_Click">
                        <i class="bi bi-box-arrow-up"></i> Confirm Dispatch
                    </asp:LinkButton>
                </div>
            </div>
                ...
                <div class="card border border-light shadow-sm p-4 rounded-3 bg-white h-100">
                    ...
                    <asp:PlaceHolder ID="phNoProduct" runat="server">
                        <div class="text-center py-5 text-muted my-auto">
                            ...
                            <p class="mb-0 small">Scan an item or enter an SKU code to verify physical inventory before dispatching.</p>
                        </div>
                    </asp:PlaceHolder>
                </div>
            </div>
